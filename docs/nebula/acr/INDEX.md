...
| [ACR-DGIX-017](ACR-DGIX-017.md) | ACI-DGIX-017 real TAIG Facebook validation | BLOCKED | Operator must configure TAIG Page id and Page token; no fabricated PASS |
